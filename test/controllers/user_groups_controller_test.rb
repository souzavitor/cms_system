...
class UserGroupsControllerTest < ActionController::TestCase
  ...
  test "should create user_group" do
    assert_difference('UserGroup.count') do
      post :create, user_group: { : @user_group., description: @user_group.description, has_and_belongs_to_many: @user_group.has_and_belongs_to_many, name: @user_group.name, slug: @user_group.slug, st: @user_group.st }
    end
  ...
  test "should update user_group" do
    patch :update, id: @user_group, user_group: { : @user_group., description: @user_group.description, has_and_belongs_to_many: @user_group.has_and_belongs_to_many, name: @user_group.name, slug: @user_group.slug, st: @user_group.st }
    assert_redirected_to user_group_path(assigns(:user_group))
  end
