...
class SystemUsersControllerTest < ActionController::TestCase
  ...
  test "should create system_user" do
    assert_difference('SystemUser.count') do
      post :create, system_user: { email: @system_user.email, name: @system_user.name, password: @system_user.password, st: @system_user.st, username: @system_user.username }
    end
  ...
  test "should update system_user" do
    patch :update, id: @system_user, system_user: { email: @system_user.email, name: @system_user.name, password: @system_user.password, st: @system_user.st, username: @system_user.username }
    assert_redirected_to system_user_path(assigns(:system_user))
  end
